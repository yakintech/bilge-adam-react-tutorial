        ...
        <div style={{ display: 'grid', gridTemplateColumns: "auto auto auto auto" }}>
            {
                products.map(item => {
                    ...
                    return <ProductBox id={item.id} name={item.name} unitPrice={item.unitPrice} unitsInStock={item.unitsInStock} categoryId={item.categoryId} quantityPerUnit={item.quantityPerUnit} color={color} />
                })
            }
        </div>
